...
import { update, index } from '@/routes/venues';
...
export default function EditVenue({ venue }: { venue: Venue }) {
    const [accessibility, setAccessibility] = useState<string[]>(venue.accessibility || []);
    const [layout, setLayout] = useState<string[]>(venue.layout || []);
    const page = usePage();
    ...
    useEffect(() => {
        if (flash?.success) {
            ...
            // Reset form fields
            setAccessibility(venue.accessibility || []);
            setLayout(venue.layout || []);
        }
    }, [flash?.success, venue]);
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            max="5"
                                            step="0.1"
                                            defaultValue={venue.avg_ratings}
                                        />
